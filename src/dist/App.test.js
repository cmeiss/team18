...
describe("Tesing User List in App", function () {
    beforeEach(function () {
        CustomRender_1.renderWithDnd(react_1["default"].createElement(UserList_1.UserList, { users: users, setUsers: setUsers, tasks: TASKS_1.TASKS, setTasks: setTasks, user: User1, setUser: setUser }));
    });
    test("list is displayed", function () {
    ...
    test("list not seen by super", function () {
        var container = CustomRender_1.renderWithDnd(react_1["default"].createElement(UserList_1.UserList, { users: users, setUsers: setUsers, tasks: TASKS_1.TASKS, setTasks: setTasks, user: User2, setUser: setUser })).container;
        expect(container).toBeEmptyDOMElement();
    });
    test("list not seen by admin", function () {
        var container = CustomRender_1.renderWithDnd(react_1["default"].createElement(UserList_1.UserList, { users: users, setUsers: setUsers, tasks: TASKS_1.TASKS, setTasks: setTasks, user: User3, setUser: setUser })).container;
        expect(container).toBeEmptyDOMElement();
    });
});
describe("Tesing Admin List in App", function () {
    beforeEach(function () {
        CustomRender_1.renderWithDnd(react_1["default"].createElement(adminlist_1.AdminList, { users: users, setUsers: setUsers, tasks: TASKS_1.TASKS, user: User3, setTasks: setTasks }));
    });
    test("list is displayed", function () {
        var listDisplayed = react_2.screen.getByText("Pending List");
        expect(listDisplayed).toBeInTheDocument();
    });
    test("list not seen by user", function () {
        var container = CustomRender_1.renderWithDnd(react_1["default"].createElement(adminlist_1.AdminList, { users: users, setUsers: setUsers, tasks: TASKS_1.TASKS, user: User1, setTasks: setTasks })).container;
        expect(container).toBeEmptyDOMElement();
    });
});
describe("Testing Delete task in App", function () {
    beforeEach(function () {
        return CustomRender_1.renderWithDnd(react_1["default"].createElement(deleteTask_component_1.DeleteTask, { tasks: TASKS_1.TASKS, setTasks: function () {
...
describe("Testing EditTask", function () {
    ...
    test("edit Task button appears", function () {
        var editButton = react_2.screen.getByRole("button", { name: "Edit ✏️" });
