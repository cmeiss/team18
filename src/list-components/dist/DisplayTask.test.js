...
describe("DisplayView Tests", function () {
    beforeEach(function () {
        react_2.render(react_1["default"].createElement(DisplayTask_1.DisplayTask, { task: testTask, tasks: tasks, updateTasks: setTasks, role: testRole1 }));
    });
    test("Taskname is displayed", function () {
        var taskName = react_2.screen.getByText(/test/i);
        expect(taskName).toBeInTheDocument();
    });
    test("Num of TaskUsers is there if role is super", function () {
        var UserNum = react_2.screen.getByText(/Number of Users/i);
...
describe("DisplayView Tests", function () {
    beforeEach(function () {
        react_2.render(react_1["default"].createElement(DisplayTask_1.DisplayTask, { task: testTask, tasks: tasks, updateTasks: setTasks, role: testRole2 }));
    });
